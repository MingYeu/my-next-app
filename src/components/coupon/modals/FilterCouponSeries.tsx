...
const CouponSeriesFilterDrawer: React.FC<FilterAttributes> = ({ filterCouponForm, onReset, onSearch, loading }) => {
                    ...
                    <Row gutter={[16, 0]}>
                        <Col {...fullBreakPoint}>
                            <Form.Item initialValue="" name="name">
                                <Input placeholder={t('Coupon Series') as string} />
                            </Form.Item>
                        </Col>
...
export default CouponSeriesFilterDrawer;
