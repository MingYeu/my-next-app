...
interface FilterAttributes {
    filterPackageForm: FormInstance;
    onReset: () => void;
    onSearch: () => void;
    loading: boolean;
}

const FilterDrawer: React.FC<FilterAttributes> = ({ filterPackageForm, onReset, onSearch, loading }) => {
    const { t } = useTranslation(['package', 'common']);
    const criteriaSelected = filterPackageForm.getFieldsValue();
